...
- Post limit offers in the trade widget (use smaller clips if trade risk is high).
- Only edit `plan.json` if you want to permanently change the main selling percentages.
- Add a short line in the Log below.
